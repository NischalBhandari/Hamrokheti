...
doSomething=(head,img,number,mobile1)=>e=>{
	this.setState({
...
render(){
	...
	const slides=items.map((item)=>{
		return (
			...
			<Card body inverse style={{backgroundColor:color,color:textColor,border:'1px solid #90cc42'}} onClick={this.doSomething(item.Heading,item.src,item.Phone,item.Mobile1)}>
